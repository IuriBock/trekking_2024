...
#!!!!!!!!!!!!!!!!!! Precisa-se calibrar a variação do "duty" para o servo testando valor por valor
...
# motor_forward(pin_pwm, pin_in1, pin_in2)

# motor_backward(pin_pwm, pin_in1, pin_in2)
